...
public class CustomChestplate extends ArmorItem {

    private String description;
    private String name;
    private int def, atk;

    public CustomChestplate(String name, ArmorMaterial armorMaterial, Properties properties, String description) {
