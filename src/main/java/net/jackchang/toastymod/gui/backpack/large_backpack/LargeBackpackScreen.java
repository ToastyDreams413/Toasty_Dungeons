...
public class LargeBackpackScreen extends AbstractContainerScreen<LargeBackpackContainer> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ToastyMod.MOD_ID, "textures/gui/large_backpack_gui.png");

    public LargeBackpackScreen(LargeBackpackContainer container, Inventory playerInventory, Component name) {
