...
public class MediumBackpackScreen extends AbstractContainerScreen<MediumBackpackContainer> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ToastyMod.MOD_ID, "textures/gui/medium_backpack_gui.png");

    public MediumBackpackScreen(MediumBackpackContainer container, Inventory playerInventory, Component name) {
