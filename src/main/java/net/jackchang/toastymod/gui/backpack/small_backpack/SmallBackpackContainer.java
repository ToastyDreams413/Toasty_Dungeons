...
public class SmallBackpackContainer extends AbstractContainerMenu {
    ...
    public static SmallBackpackContainer fromNetwork(final int windowId, final Inventory playerInventory, FriendlyByteBuf data) {
        return new SmallBackpackContainer(windowId, playerInventory, new ItemStackHandler(9));
    }

    public SmallBackpackContainer(int id, Inventory playerInventory, IItemHandler handler) {
        super(Containers.SMALL_BACKPACK.get(), id);
        itemHandler = handler;
    ...
    public ItemStack quickMoveStack(Player playerIn, int index) {
        ...
        if (index < containerSlots) {
            ...
            if (!this.moveItemStackTo(stack, 0, backpackRowSize, false)) {
                return ItemStack.EMPTY;
            }
        }
        if (!this.moveItemStackTo(stack, 0, backpackRowSize, false)) {
