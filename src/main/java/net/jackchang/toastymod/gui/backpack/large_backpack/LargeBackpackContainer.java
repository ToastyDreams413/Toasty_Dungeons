...
public class LargeBackpackContainer extends AbstractContainerMenu {
    private final IItemHandler itemHandler;
    private int blocked = -1;
    private int backpackRowSize = 0;
    private int rows = 0;

    public static LargeBackpackContainer fromNetwork(final int windowId, final Inventory playerInventory, FriendlyByteBuf data) {
        return new LargeBackpackContainer(windowId, playerInventory, new ItemStackHandler(27));
    }

    public LargeBackpackContainer(int id, Inventory playerInventory, IItemHandler handler) {
        super(Containers.LARGE_BACKPACK.get(), id);
        itemHandler = handler;
