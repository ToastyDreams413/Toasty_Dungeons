...
public class SmallBackpackScreen extends AbstractContainerScreen<SmallBackpackContainer> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ToastyMod.MOD_ID, "textures/gui/small_backpack_gui.png");

    public SmallBackpackScreen(SmallBackpackContainer container, Inventory playerInventory, Component name) {
